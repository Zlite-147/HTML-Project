...
function mouseOut() {
  ...
  <div class="w3-row-padding">
    <div class="w3-third w3-container w3-margin-bottom">
      <a href="nano.html"><img src="https://transhumanismnews.files.wordpress.com/2015/10/nc3a9vtelen.png" alt="Nano" style="width:100%" class="w3-hover-opacity"></a>
      <div class="w3-container w3-white">
        <p><b>Nano Technology</b></p>
        <p>The branch of technology that deals with dimensions and tolerances of less than 100 nanometres, especially the manipulation of individual atoms and molecules.Translate nanotechnology to Use over time for: nanotechnology.</p>
      </div>
    </div>
    <div class="w3-third w3-container w3-margin-bottom">
